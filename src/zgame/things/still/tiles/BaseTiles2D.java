...
public final class BaseTiles2D{
	...
	public static final ColorTile AIR = new ColorTile("air", BASE_ORIGIN, TileHitbox2D.NONE, new ZColor(0, 0, 0, 0), Materials.NONE);
	/** A tile with no hitbox which displays as a dark color */
	public static final ColorTile BACK_DARK = new ColorTile("backDark", BASE_ORIGIN, TileHitbox2D.NONE, new ZColor(.2), Materials.NONE);
	/** A tile with no hitbox which displays as a light color */
	public static final ColorTile BACK_LIGHT = new ColorTile("backLight", BASE_ORIGIN, TileHitbox2D.NONE, new ZColor(.35), Materials.NONE);
	/** A tile with a solid hitbox that displays as a dark solid color */
	public static final ColorTile WALL_DARK = new ColorTile("wallDark", BASE_ORIGIN, TileHitbox2D.FULL, new ZColor(.55));
	/** A tile with a solid hitbox that displays as a light solid color */
	public static final ColorTile WALL_LIGHT = new ColorTile("wallLight", BASE_ORIGIN, TileHitbox2D.FULL, new ZColor(.65));
	/** A tile with a solid hitbox that displays as a light solid color */
	...
	public static final ColorTile BOUNCY = new ColorTile("bouncy", BASE_ORIGIN, TileHitbox2D.FULL, new ZColor(1, .5, .5), Materials.BOUNCE);
	/** A brown tile with a huge friction value */
	public static final ColorTile HIGH_FRICTION = new ColorTile("highFriction", BASE_ORIGIN, TileHitbox2D.FULL, new ZColor(.25, .125, .0625), Materials.HIGH_FRICTION);
